<template>
  <div
    class="ipc-tree"
    :style="'display: inline; ' + 'padding-left: ' + depth + ';'"
  >
    <div :style="indent">
      <div style="padding-right: 30%">
        ...
        <div :class="depth + '-class-phrase'" :style="phraseColor">
          <router-link
          target="_blank"
          :class="depth + '-class-phrase'"
          :to="'/analysis/tech?tech=' + title.content"
    ...
    <div v-if="showChildren">
      <ipc-tree
        :style="
          'display: inline; ' + 'padding-left: ' + (depth + 1) * 100 + 'px;'
        "
