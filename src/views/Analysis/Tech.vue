...
export default {
  ...
  mounted() {
    let uuid = this.uuid;
    this.$store.dispatch("tech/getTitle", uuid);
    this.$store.dispatch("tech/getResTech", uuid);
    this.$store.dispatch("tech/getResCategory", uuid);
    this.$store.dispatch("tech/getResOrg", uuid);
    this.$store.dispatch("tech/getResIndustry", uuid);
  },
  computed: {
    ...mapState({
      titleData: state => state.tech.titleData,
      resTech: state => state.tech.resTech,
      resCategory: state => state.tech.resCategory,
      resOrg: state => state.tech.resOrg,
      resIndustry: state => state.tech.resIndustry
    }),
    uuid() {
