  ...
  <div class="w">
    ...
    <div class="part">
      <DetailedChart
        ...
        :chartOptionOne="resIndustry.data"
      />
    </div>
    <div class="part">
      <DetailedChart
...
export default {
  ...
  computed: {
    ...mapState({
      titleData: state => state.industry.titleData,
      resTech: state => state.industry.resTech,
      resCategory: state => state.industry.resCategory,
      resOrg: state => state.industry.resOrg,
      resIndustry: state => state.industry.resIndustry
    }),
    uuid() {
